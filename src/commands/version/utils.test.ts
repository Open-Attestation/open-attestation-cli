...
describe("Upgrade Check", () => {
    describe("Release Check", () => {
        const assets: GithubAssetsSchema[] = [
            {
                ...
                "browser_download_url": "https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-linux"
            },
            {
                ...
                "browser_download_url": "https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-macos"
            },
            {
                ...
                "browser_download_url": "https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-win.exe"
            }
        ]
        ...
        it("should be able to get the latest release assets - windows", async () => {
            ...
            expect(release!.url).toBe("https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-win.exe");
        });
        ...
        it("should be able to get the latest release assets - linux", async () => {
            ...
            expect(release!.url).toBe("https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-linux");
        });
        ...
        it("should be able to get the latest release assets - mac", async () => {
            ...
            expect(release!.url).toBe("https://github.com/Open-Attestation/open-attestation-cli/releases/download/v1.55.0/open-attestation-macos");
        });
    });
});