...
import { AddressLength, defaultRunParameters, EndStatus, network, owner, receiver, TokenIdLength, TokenInfo } from "../constants";
...
export const checkNominateSuccess = (results: string) => {
