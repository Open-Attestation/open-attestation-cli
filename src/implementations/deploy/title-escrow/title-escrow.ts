import { TitleEscrowCloneable, TitleEscrowCloneableFactory, TitleEscrowCloner } from "@govtechsg/token-registry";
...
//   if (dryRun) {
//     const factory = new TitleEscrowCloner();
//     await dryRunMode({
//       network,
...
//   const factory = new TitleEscrowCloneableFactory(wallet);
//   signale.await(`Sending transaction to pool`);
//   const transaction = await factory.deployNew(tokenRegistry, beneficiary, holder, titleEscrowFactoryAddress, {
